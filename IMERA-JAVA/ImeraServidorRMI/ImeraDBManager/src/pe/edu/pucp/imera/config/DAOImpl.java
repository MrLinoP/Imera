 ...
 */
package pe.edu.pucp.imera.config;
...
public abstract class DAOImpl {
    ...
    protected String predicadoParaListado;
    ...
    public DAOImpl(String nombre_tabla) {
        ...
        this.predicadoParaListado=null;
    }
    ...
    protected String generarSQLParaListarTodos(Integer limite) {
        ...
        sql = sql.concat(this.incluirJoins());
        sql = sql.concat(this.predicadoParaListado);
